...
- `Trust+Consumer` (🔎) = signals you read in *other people / things* → rename to **Signals** — "What earns or loses your trust".
...
If you want a different slot for any of these (Aspirations / Dream Log near Seeking, Sizing near Aura, etc.) say so and I'll adjust before building.
