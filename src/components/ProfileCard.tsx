    ...
    >
      <div className="relative h-full w-full overflow-hidden rounded-3xl shadow-elevated">
        ...
        {isTop && (
          <>
            <motion.div
              className="absolute left-6 top-8 z-20 rounded-xl border-4 border-green-400 px-4 py-2 font-display text-2xl font-bold text-green-400"
              style={{ opacity: likeOpacity, rotate: -12 }}
            >
              LIKE 💚
            </motion.div>
            <motion.div
              className="absolute right-6 top-8 z-20 rounded-xl border-4 border-red-400 px-4 py-2 font-display text-2xl font-bold text-red-400"
